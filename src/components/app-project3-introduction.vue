    ...
    <div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                Suppose you want to conceal n bits of data in each color level of a pixel. Then you could use the following scheme. Say that you want to conceal the data value v in a color level c. The program then alters the color level slightly so that it becomes c', such that c' mod 2n = v. To extract the concealed data, the program takes the color level modulo 2n.<br><br>
...
import '@/app.css'
export default{
    component: 'app-project3-introduction.vue'
}
</script>
